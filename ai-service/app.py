...
# 1. Cuma butuh daftarin Custom Layer (Gak pake jurus ninja lagi)
...
# 2. LOAD MODEL YANG UDAH DIBERSIHIN
print("Memuat model AI Clean... (Tunggu sebentar)")
model = keras.saving.load_model(
    'staypath_ai_clean.keras',  # <-- Kita pakai file yang bersih!
...
def predict_risk():
    try:
        ...
        print("Terjadi Error saat Prediksi:", str(e))
